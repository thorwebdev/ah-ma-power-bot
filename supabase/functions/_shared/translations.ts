export const prompts = ({
  ...
  const prompts: { [key: string]: { [key: string]: string } } = {
    ...
    welcome: {
      ...
      cn: `您好! 我是Dove, 我在这里帮助您制作简历。📄\n\n只需回答我的问题, 就能得到全新的简历。 请注意，DoveJob 绝不会要求您提供银行账户详细信息，或要求您进行汇款。\n\n如果您准备好了, 请选择您偏好的语言。😊`,
...
\n• What jobs did you do in the past 5 years (if any)?\n• What are your key responsibilities in your previous/current job?\n• When was that job?`,
      cn: `现在请描述您的工作经历！💼\n\n您可以用语音留言回答, 并可以使用任何语言, 无需打字!  🗣️\n\n以下是一些您可以谈论的内容：\n• 过去五年内您做过哪些工作（如果有的话）？
\n• 您在目前/上一份工作中的主要职责是什么？\n•  您是什么时候作的那份工？\n•  您是否愿意通过课程提升自己来寻找新的工作机会?  `,
...
\n• முன்னர்/தற்போதைய பணியாளர் வேலையில் உங்கள் முதன்மை பொருளாதாரங்கள் என்ன?\n• ஆன பணியாளர் எப்போது?`,
    ...
    "step-4": {
      ...
      cn: `谢谢! 最后, 请使用手机的前置摄像头拍一张您的头像, 最好使用白色背景。\n\n如果您不想拍照, 请回复"No"。`,
    ...
    "step-5": {
      ...
      cn: `请稍等, 我们正在生成您的简历。一旦简历准备好, 您将收到通知。`,
    ...
    "step-6": {
      ...
      cn: "就快结束了\\! 请查看您的简历, 并告知我们您是否愿意我们将其提交到 SilverJobs 平台\\。 \n\n 点击*申请*即表示您同意 SilverJobs [条款和条件](https://silverjobs.sg/site/tnc) 以及 [CFS](https://cfs.org.sg) \\(老年人中心\\) 与您联系以获得未来的机会\\。",
    ...
    "step-final": {
      ...
      cn: "谢谢, 您的简历已提交给SilverJobs, 当有合适的机会时, 他们会与您联系。",
